package com.ppamorim.calculator.core.view;
...
public class CustomSlidingTabStrip extends HorizontalScrollView implements View.OnClickListener {
  ...
  public CustomSlidingTabStrip(Context context, AttributeSet attrs) {
    super(context, attrs);
